...
"use strict";
eval("\nvar __extends = (this && this.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        if (typeof b !== \"function\" && b !== null)\n            throw new TypeError(\"Class extends value \" + String(b) + \" is not a constructor or null\");\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.UFO = void 0;\nvar BaseGameScene_1 = __webpack_require__(/*! ./BaseGameScene */ \"./src/scenes/BaseGameScene.ts\");\nvar End_UFO_1 = __webpack_require__(/*! ./End_UFO */ \"./src/scenes/End_UFO.ts\");\nvar UFO = /** @class */ (function (_super) {\n    __extends(UFO, _super);\n    function UFO() {\n        var _this = _super.call(this, { key: UFO.name }) || this;\n        _this.velocity = 0;\n        _this.mult = -1;\n        _this.vegs = [];\n        return _this;\n    }\n    UFO.prototype.create = function () {\n        _super.prototype.create.call(this);\n        this.bg = this.add.tileSprite(0, 0, window.innerWidth, window.innerHeight, \"background\");\n        this.bg.setOrigin(0, 0);\n        this.ufo = this.add.sprite(this.width / 5, this.height / 2, 'ufo');\n        this.ufo.displayWidth = this.width / 5;\n        this.ufo.displayHeight = this.height / 10;\n        this.ufo.setInteractive();\n    };\n    UFO.prototype.setVelocity = function (delta) {\n        this.velocity += ((this.mult * 2) * (delta / 1000));\n    };\n    UFO.prototype.revVelocity = function () {\n        this.velocity = 0;\n        this.mult = 2;\n    };\n    UFO.prototype.retVelocity = function () {\n        this.velocity = 0;\n        this.mult = -2;\n    };\n    UFO.prototype.createRandomVeg = function () {\n        var a = Math.random();\n        if (a < .01) {\n            var veg = this.add.sprite(window.innerWidth, window.innerHeight * (Math.random() * 0.6 + 0.2), 'veg');\n            veg.displayHeight = this.width / 15;\n            veg.displayWidth = this.width / 15;\n            this.vegs.push(veg);\n            veg.setInteractive();\n            this.physics.add.collider(this.ufo, veg, function (p, s) {\n                console.log('collision');\n                s.destroy(true);\n            });\n        }\n    };\n    UFO.prototype.update = function (time, delta) {\n        var _this = this;\n        if (this.ufo.y > window.innerHeight || this.ufo.y < 0) {\n            this.scene.start(End_UFO_1.End_UFO.name);\n        }\n        this.bg.tilePositionX += 6;\n        this.input.on(\"pointerdown\", this.revVelocity, this);\n        this.input.on(\"pointerup\", this.retVelocity, this);\n        this.setVelocity(delta);\n        this.ufo.setY(this.ufo.y - this.velocity);\n        this.vegs.forEach(function (veg) {\n            veg.setX(veg.x - 6);\n            if (veg.x < 100 + _this.width / 10 && veg.x > 100 - _this.width / 10) {\n                if (veg.y > _this.ufo.y - _this.height / 20 && veg.y < _this.ufo.y + _this.height / 20) {\n                    veg.destroy(true);\n                }\n            }\n        });\n        this.createRandomVeg();\n        console.log('x: ' + this.ufo.x);\n        console.log('y: ' + this.ufo.y);\n    };\n    return UFO;\n}(BaseGameScene_1.BaseGameScene));\nexports.UFO = UFO;\n\n\n//# sourceURL=webpack:///./src/scenes/UFO.ts?");

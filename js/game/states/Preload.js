...
collectFood.Preload.prototype = {
    preload: function(){
        ...
        this.load.spritesheet('beef','assets/images/beef.png',51,51,0);
        this.load.spritesheet('candy','assets/images/candy.png',51,51,0);
        this.load.spritesheet('vrius','assets/images/vrius.png',51,51,0);

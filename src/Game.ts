...
import { Load_Opening } from "./scenes/Load_Opening"
...
class Game extends Phaser.Game {
  ...
  private constructor() {
    const config = {
      ...
      pixelArt: false,
      scene: [Load_Opening, OpeningScene, Load_Hub, Hub, Load_UFO, UFO, End_UFO, LoadScene, MenuScene, GameScene, GameUIScene, FoodPrep, VT_Tut],
      type: 0,
      width: 500,
      zoom: 1,
    };
